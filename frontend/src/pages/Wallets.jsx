        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '24px' }}>
            ...
            <div className="glass-panel" style={{ padding: '24px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    {wallets.length === 0 ? <p style={{ color: 'var(--text-secondary)' }}>Chưa có ví nào.</p> : wallets.map(wallet => (
                        <div key={wallet.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px', border: '1px solid var(--border-color)', borderRadius: '12px', background: 'rgba(255,255,255,0.02)' }}>
                            <div>
